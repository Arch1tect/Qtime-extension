(function() {
	...
	ui.init.push(function() {
		...
		$(document).mousemove(function(e){
			...
			prev_x = e.clientX;
			prev_y = e.clientY;
			contentObj.chatboxDiv.width = boxW;
			contentObj.chatboxDiv.height = boxH;
			$('#socket-chatbox-embeded').css('height', (boxH)+"px !important");
			$('#socket-chatbox-embeded').css('width', (boxW)+"px !important");
	...
	function show() {
		...
		$('#socket-chatbox-embeded').css('height', '415px');
		$('#socket-chatbox-embeded').css('width', '350px');
	}
	...
	function hide() {
		...
		$('#socket-chatbox-embeded').css('height', '30px');
		$('#socket-chatbox-embeded').css('width', '200px');
	}
